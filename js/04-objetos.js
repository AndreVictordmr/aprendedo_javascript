...
const aluno ={
    nome_completo: 'André',
    data_de_nascimento: '10/09/1995',
    telefone :['0888-5555','98175-2407'],
    endereco: {
        rua:' Rua A',
        numero:'95',
        bairro:'Jardim ABC'
...
console.log(`Aqui estao os dados do aluno ${aluno.nome_completo}:
     Numero de celular: ${aluno.telefone[1]}.
